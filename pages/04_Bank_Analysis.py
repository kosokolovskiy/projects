...
import pandas as pd
from projects.project_3.utils_3 import introduction_p_3
from projects.project_3.utils_3 import eda_p_3
from projects.project_3.utils_3 import model_selection_p_3
from projects.project_3.utils_3 import conclusions_p_3
...
def introduction():
    ...
    introduction_p_3.main()

def model_selection():
    st.header('Model Selection')
    model_selection_p_3.main()


def conclusions():
    st.header('Conclusions')
    conclusions_p_3.main()
...
def onClick(selection_input):
    if selection_input == 'Conclusions':
        st.session_state['selection_project_3'] = 3
    elif selection_input == 'EDA':
        st.session_state['selection_project_3'] = 1
    elif selection_input == 'Introduction':
        st.session_state['selection_project_3'] = 0
    elif selection_input == 'Model Selection':
        st.session_state['selection_project_3'] = 2

def main_project_3():
    st.title('Stock Price Analysis')

    if 'selection_project_3' not in st.session_state:
        st.session_state['selection_project_3'] = 0
    ...
    step_analysis = st.sidebar.selectbox('Step of Analysis: ', step_analysis_lst, index=st.session_state['selection_project_3'])
