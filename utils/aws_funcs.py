...
S3_BUCKET_NAME_PROJECTS = st.secrets['STREAMLIT_S3_BUCKET_NAME_PROJECTS']
AWS_ACCESS_KEY_PROJECTS = st.secrets['STREAMLIT_AWS_ACCESS_KEY_PROJECTS']
AWS_SECRET_KEY_PROJECTS = st.secrets['STREAMLIT_AWS_SECRET_KEY_PROJECTS']
